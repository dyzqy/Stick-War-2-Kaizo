package com.brockw.stickwar.campaign
{
      ...
      public class EndOfGameSummary extends Screen
      {
            ...
            public function EndOfGameSummary(param1:stickwar2)
            {
                  super();
                  this.main = param1;
            ...
            override public function enter() : void
            {
                  ...
                  var _loc4_:int = 0;
                  _loc5_ = 0;
                  while(_loc5_ < this.main.campaign.levels.length)
                  {
                  ...
                  while(_loc5_ < this.main.campaign.levels.length)
                  {
                        if((_loc6_ = this.main.campaign.levels[_loc5_]).bestTime < 0)
                        {
                              _loc6_.bestTime = 0;
                        }
                        _loc8_ = _loc6_.title;
            ...
            private function playOnline(param1:Event) : void
            {
            ...
            private function mainMenu(param1:Event) : void
            {
