package com.brockw.stickwar.campaign
{
      ...
      public class CampaignGameScreen extends GameScreen
      {
            ...
            public var stageLevel:*;
            
            public var music:String = "orderInGame";
            ...
            override public function enter() : void
            {
                  ...
                  this.stageLevel = main.campaign.getCurrentLevel();
                  var _loc1_:Level = this.stageLevel;
                  ...
                  _loc3_ = 0;
                  _loc4_ = 1;
                  var _loc5_:* = _loc1_.normalModifier;
                  ...
                  {
                        (_loc9_ = CampaignUpgrade(main.campaign.upgradeMap["Cloak_BASIC"])).upgraded = true;
                  ...
                  if(main.campaign.getCurrentLevel().hasInsaneWall && main.campaign.difficultyLevel == Campaign.D_INSANE)
                  {
                        ...
                        {
                              (_loc10_ = team.enemyTeam.addWall(team.enemyTeam.homeX - 900)).setConstructionAmount(1);
                        }
                        else
                        {
                  ...
                  if(main.campaign.currentLevel != 0)
                  {
                        ...
                        {
                              _loc8_.push([game.team.getMinerType()]);
                              (_loc10_ = team.addWall(team.homeX + 1200)).setConstructionAmount(1);
                        }
                  }
                  else
                  {
            ...
            public function setMusic(param1:String) : void
            {
                  game.soundManager.playSoundInBackground(param1);
            }
