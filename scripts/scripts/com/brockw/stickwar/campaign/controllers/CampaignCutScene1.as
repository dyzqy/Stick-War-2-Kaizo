package com.brockw.stickwar.campaign.controllers
{
      ...
      public class CampaignCutScene1 extends CampaignController
      {
            ...
            private static const S_FINISH_CAMPAIGN:int = 10;
            ...
            override public function update(param1:GameScreen) : void
            {
                  ...
                  param1.userInterface.hud.hud.fastForward.alpha = 0;
                  if(this.message)
                  {
                        this.message.update();
                  }
                  ...
                  else if(this.state == S_MEDUSA_TALKS_3)
                  {
                        ...
                        if(this.message.hasFinishedPlayingSound())
                        {
                              this.state = S_FINISH_CAMPAIGN;
                        }
                  }
                  else if(this.state == S_FINISH_CAMPAIGN)
                  {
                        param1.game.targetScreenX = param1.game.team.enemyTeam.statue.x - 350;
                        param1.game.screenX = param1.game.team.enemyTeam.statue.x - 350;
                        this.message.setMessage("This is the end of the current campaign, thank you for playing! If you want the second part of the campaign, you must wait for someone to beat this current campaign legitimently, or do it yourself...","");
                        if(this.message.hasFinishedPlayingSound())
                        {
                              this.counter = -30 * 6;
                              ++this.counter;
