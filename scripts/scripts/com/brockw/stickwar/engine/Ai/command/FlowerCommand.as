package com.brockw.stickwar.engine.Ai.command
{
      ...
      public class FlowerCommand extends UnitCommand
      {
            
            public static const actualButtonBitmap:Bitmap = new Bitmap(new flowerBitmap());
             
            
            private var range:Number;
            
            public function FlowerCommand(param1:StickWar)
            {
                  super();
                  this.game = param1;
                  type = UnitCommand.FLOWER;
                  hotKey = 81;
                  _hasCoolDown = true;
                  ...
                  cursor = new thornCursorMc();
                  if(param1 != null)
                  {
                        this.range = param1.xml.xml.Elemental.Units.treeElement.flower.range;
                        this.loadXML(param1.xml.xml.Elemental.Units.treeElement.flower);
                  }
            }
            ...
            {
                  return TreeElement(param1).flowerCooldown();
            }
            
            override public function isFinished(param1:Unit) : Boolean
            {
                  return TreeElement(param1).flowerCooldown() != 0 || this.targetId == -1;
            }
