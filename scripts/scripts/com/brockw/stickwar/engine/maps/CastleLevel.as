package com.brockw.stickwar.engine.maps
{
      ...
      public class CastleLevel extends Map
      {
            ...
            public function CastleLevel(param1:StickWar)
            {
                  super();
                  this.init(param1);
            }
            ...
            override public function init(param1:StickWar) : void
            {
                  ...
                  _loc2_.push(new castleLevelForeground());
                  _loc2_.push(new castleLevelMiddleground());
                  _loc2_.push(new castleLevelBackground());
