package com.brockw.stickwar.engine.Team
{
      ...
      public class Team
      {
            ...
            public static function getTeamFromId(param1:int, param2:StickWar, param3:int, param4:Dictionary, param5:* = 1, param6:Number = 1) : Team
            {
                  var _loc7_:* = param1;
                  if(param1 == Team.T_RANDOM)
                  {
                  ...
                  else if(param1 == Team.T_ELEMENTAL)
                  {
            ...
            public static function getRaceNameFromId(param1:int) : String
            {
                  ...
                  if(param1 == Team.T_CHAOS)
                  {
                        return "Chaos";
                  }
                  if(param1 == Team.T_ELEMENTAL)
                  {
                        return "Elemental";
                  }
                  if(param1 == Team.T_RANDOM)
            ...
            public function update(param1:StickWar) : void
            {
                  ...
                  if(param1.map.hills.length != 0)
                  {
                        ...
                        {
                              if(this.tech.isResearched(Tech.TOWER_SPAWN_I) || this.tech.isResearched(Tech.SPAWN_SHADOW) || this.tech.isResearched(Tech.SPAWN_MAGE))
                              {
            ...
            public function set enemyTeam(param1:Team) : void
            {
            ...
            public function set tech(param1:Tech) : void
            {
                  this._tech = param1;
            }
            ...
            public function set castleDefence(param1:CastleDefence) : void
            {
