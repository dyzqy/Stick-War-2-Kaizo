package gs.plugins
{
   ...
   public class AutoAlphaPlugin extends TweenPlugin
   {
      ...
      {
         if(Boolean(this._tweenVisible) && this._tween.vars.runBackwards != true && this._tween.ease == this._tween.vars.ease)
         {
      ...
      {
         updateTweens(param1);
         if(this._target.visible != true && Boolean(this._tweenVisible))
         {
