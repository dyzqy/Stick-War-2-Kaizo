package com.google.analytics.debug
{
   ...
   public class Layout implements ILayout
   {
      ...
      public function init() : void
      {
         ...
         var _loc4_:com.google.analytics.debug.Panel;
         (_loc4_ = new com.google.analytics.debug.Panel("analytics",_loc2_,_loc3_)).alignement = Align.top;
      ...
      public function addToPanel(param1:String, param2:DisplayObject) : void
      {
         ...
         if(_loc3_)
         {
            (_loc4_ = _loc3_ as com.google.analytics.debug.Panel).addData(param2);
         }
         else
         {
      ...
      {
         var _loc4_:com.google.analytics.debug.Panel;
         (_loc4_ = new com.google.analytics.debug.Panel(param1,param2,param3)).alignement = Align.center;
         _loc4_.stickToEdge = false;
         addToStage(_loc4_);
         bringToFront(_loc4_);
      }
