package com.smartfoxserver.v2.core
{
   ...
   public class SFSIOHandler implements IoHandler
   {
      ...
      public function onDataRead(param1:ByteArray) : void
      {
         ...
         {
            if(param1.length > 1024 && this.fullPacketDump == false)
            {
      ...
      private function handleNewPacket(param1:ByteArray) : ByteArray
      {
         ...
         if(!(_loc2_ & 128) > 0)
         {
            throw new SFSError("Unexpected header byte: " + _loc2_,0,DefaultObjectDumpFormatter.hexDump(param1));
         }
