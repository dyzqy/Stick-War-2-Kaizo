package com.smartfoxserver.v2
{
   ...
   public class SmartFox extends EventDispatcher
   {
      ...
      public function enableFullPacketDump(param1:Boolean) : void
      {
         (this._bitSwarm.ioHandler as SFSIOHandler).enableFullPacketDump(param1);
      }
      
      public function enableLagMonitor(param1:Boolean, param2:int = 4, param3:int = 10) : void
      {
         ...
         if(param1)
         {
            this._lagMonitor = new LagMonitor(this,param2,param3);
      ...
      kernel function setAlternateIOHandler(param1:IoHandler) : void
      {
         if(!this._isConnected && !this._isConnecting)
         {
            this._bitSwarm.ioHandler = param1;
            return;
         }
