package com.brockw.stickwar.engine
{
   ...
   public class SpatialHash
   {
      ...
      public function add(param1:com.brockw.stickwar.engine.Entity) : void
      {
      ...
      public function getNearbyEntitys(param1:com.brockw.stickwar.engine.Entity) : Vector.<com.brockw.stickwar.engine.Entity>
      {
         var _loc2_:int = param1.px / this.boxWidth;
         var _loc3_:int = param1.py / this.boxHeight;
      ...
      public function getNearbyEntitysXY(param1:Number, param2:Number) : Vector.<com.brockw.stickwar.engine.Entity>
      {
      ...
      public function getNumberOfNearbyEntitys(param1:com.brockw.stickwar.engine.Entity) : int
      {
         var _loc2_:int = param1.px / this.boxWidth;
         var _loc3_:int = param1.py / this.boxHeight;
         if(this.cols * _loc3_ + _loc2_ < 0 || this.cols * _loc3_ + _loc2_ >= this.partitions.length)
