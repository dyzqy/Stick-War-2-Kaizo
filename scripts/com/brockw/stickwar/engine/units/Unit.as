package com.brockw.stickwar.engine.units
{
   ...
   public class Unit extends Entity
   {
      ...
      private var _freezeLock:com.brockw.stickwar.engine.units.Unit;
      ...
      public var deadRespawn:com.brockw.stickwar.engine.units.Dead;
      ...
      public function get freezeLock() : com.brockw.stickwar.engine.units.Unit
      {
         return this._freezeLock;
      }
      
      public function set freezeLock(param1:com.brockw.stickwar.engine.units.Unit) : void
      {
      ...
      public function reaperCurse(param1:com.brockw.stickwar.engine.units.Unit) : void
      {
      ...
      protected function moveDualPartner(param1:com.brockw.stickwar.engine.units.Unit, param2:Number) : *
      {
      ...
      public function sqrDistanceToTarget(param1:com.brockw.stickwar.engine.units.Unit) : Number
      {
         if(param1 == null)
         {
      ...
      public function sqrDistanceTo(param1:com.brockw.stickwar.engine.units.Unit) : Number
      {
         if(param1 == null)
         {
            return Number.MAX_VALUE;
      ...
      public function mayAttack(param1:com.brockw.stickwar.engine.units.Unit) : Boolean
      {
         return false;
      }
      ...
      public function updateStatus() : void
      {
         ...
         if(this.fireDamageFrames > 0)
         {
            ...
            this.damage(com.brockw.stickwar.engine.units.Unit.D_NO_BLOOD | com.brockw.stickwar.engine.units.Unit.D_NO_SOUND | com.brockw.stickwar.engine.units.Unit.D_FIRE,this.fireDamagePerFrame,null);
            if(this.fireDamageFrames == 0)
            {
         ...
         if((this.isDead || this.isDieing) && !this.isDualing)
         {
            ...
            if(this.mc.contains(this.healthBar))
            {
               ...
               if(this.isPoisoned())
               {
                  ...
                  {
                     this.deadRespawn = Dead(this.team.game.unitFactory.getUnit(com.brockw.stickwar.engine.units.Unit.U_DEAD));
      ...
      protected function checkCollision(param1:com.brockw.stickwar.engine.units.Unit) : void
      {
         ...
         if(param1 == this || param1.pz != 0 || this.type == com.brockw.stickwar.engine.units.Unit.U_WATER_ELEMENT)
         {
            return;
         }
         ...
         {
            param1 = Unit(param1);
            if((!param1.mayWalkThrough || param1.type == com.brockw.stickwar.engine.units.Unit.U_TREE_ELEMENT && type == com.brockw.stickwar.engine.units.Unit.U_TREE_ELEMENT) && param1.stunTimeLeft == 0 && param1.isCollision(this,this.dx,this.dy))
            {
               _loc2_ = 0.15;
      ...
      public function stun(param1:int, param2:Number = 1) : void
      {
         ...
         if(param1 > 0)
         {
            if(this.dzOffset == 0)
            {
               this._dz = -com.brockw.stickwar.engine.units.Unit.stunUpForce * param2 * 2;
            }
      ...
      public function releaseFreezeLock(param1:com.brockw.stickwar.engine.units.Unit) : void
      {
      ...
      {
         return type == com.brockw.stickwar.engine.units.Unit.U_STATUE || type == com.brockw.stickwar.engine.units.Unit.U_CHAOS_TOWER;
      }
      ...
      public function aquireFreezeLock(param1:com.brockw.stickwar.engine.units.Unit) : Boolean
      {
         if(this.freezeLock == param1)
         {
            return true;
      ...
      public function isFreezeLocked(param1:com.brockw.stickwar.engine.units.Unit) : Boolean
      {
      ...
      protected function fractionOfCollision(param1:com.brockw.stickwar.engine.units.Unit, param2:int, param3:int) : Number
      {
      ...
      protected function isCollision(param1:com.brockw.stickwar.engine.units.Unit, param2:int, param3:int) : Boolean
      {
      ...
      {
         var _loc1_:com.brockw.stickwar.engine.units.Unit = this.ai.getClosestTarget();
         if(_loc1_ == null)
         {
            return false;
         }
      ...
      public function checkForHitPoint(param1:Point, param2:com.brockw.stickwar.engine.units.Unit) : Boolean
      {
         if(param2 == null)
         {
            return false;
      ...
      public function checkForHitPointArrow(param1:Point, param2:Number, param3:com.brockw.stickwar.engine.units.Unit) : Boolean
      {
         if(param3 == null)
         {
            return false;
      ...
      override public function damage(param1:int, param2:Number, param3:Entity, param4:Number = 1) : void
      {
         ...
         {
            if(!(com.brockw.stickwar.engine.units.Unit.D_NO_SOUND & param1))
            {
               if(this.isArmoured)
               {
                  this.team.game.soundManager.playSoundRandom("hitOnArmour",7,px,py);
            ...
            if(!(com.brockw.stickwar.engine.units.Unit.D_NO_BLOOD & param1))
            {
            ...
            if(this._health <= 0)
            {
               ...
               else if(param1 & com.brockw.stickwar.engine.units.Unit.D_ARROW)
               {
      ...
      public function startDual(param1:com.brockw.stickwar.engine.units.Unit) : Boolean
      {
